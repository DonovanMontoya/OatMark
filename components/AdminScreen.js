...
const AdminScreen = ({onClose}) => {
    ...
    const handleReject = (shopId) => {
        Alert.alert("Reject Submission", "Are you sure you want to reject this shop submission?", [{
            text: "Cancel", style: "cancel"
        }, {
    ...
    return (<View style={styles.container}>
        ...
        {loading ? (<View style={styles.loadingContainer}>
        ...
        </View>) : pendingShops.length === 0 ? (<View style={styles.emptyContainer}>
            ...
            renderItem={({item}) => (<View style={styles.card}>
                ...
                <View style={styles.cardContent}>
                    ...
                    {item.location && (<View style={styles.detailRow}>
                        <FontAwesome6
                            name="location-dot"
                            size={12}
                            color="#666"
...
const styles = StyleSheet.create({
    container: {
        ...
        width: '100%', height: 220, borderTopWidth: 1, borderBottomWidth: 1, borderColor: '#f0f0f0', overflow: 'hidden',
    }, map: {
        width: '100%', height: 180,
    }, mapButtonsContainer: {
        flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 8, backgroundColor: '#f8f8f8',
    }, mapButton: {
        flexDirection: 'row',
        alignItems: 'center',
        paddingVertical: 6,
        ...
        width: 100, height: 100, backgroundColor: "#f8f8f8", justifyContent: "center", alignItems: "center",
    }, emojiText: {
        fontSize: 40,
    }, header: {
        flexDirection: "row",
        ...
        fontSize: 18, fontWeight: "600", color: "#333", marginTop: 20, textAlign: "center",
    }, emptySubtext: {
        fontSize: 14, color: "#666", marginTop: 10, textAlign: "center",
    }, listContainer: {
        padding: 16,
    }, card: {
        ...
        fontSize: 14, color: "#666", marginLeft: 8,
    }, actionButtons: {
        ...
        fontSize: 12, color: "#4CAF50", fontWeight: "600", marginLeft: 4,
    }, rejectButton: {
        flexDirection: "row",
        alignItems: "center",
        paddingVertical: 6,
        ...
        fontSize: 12, color: "#FF3B30", fontWeight: "600", marginLeft: 4,
    },
});
